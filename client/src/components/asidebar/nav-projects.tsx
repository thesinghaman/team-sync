...
import { SafeConfirmDialog } from "../resuable/safe-confirm-dialog";
...
export function NavProjects() {
  ...
  const { data, isPending, isFetching, isError } =
    useGetProjectsInWorkspaceQuery({
      ...
      pageSize,
      pageNumber,
      skip: !workspaceId, // Skip the query when workspaceId is undefined
    });
            ...
            <div className="pl-3">
              <p className="text-xs text-muted-foreground">
                {hasPermission(Permissions.CREATE_PROJECT)
                  ? "There are no projects in this workspace yet. Projects you create will show up here."
                  : "There are no projects in this workspace yet. Ask the workspace owner to create projects."}
              </p>
              <PermissionsGuard requiredPermission={Permissions.CREATE_PROJECT}>
                <Button
                  variant="link"
