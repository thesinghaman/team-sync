    ...
    <div className="relative w-full">
      <style
        dangerouslySetInnerHTML={{
          __html: `
          .emoji-picker-no-nav .emoji-mart-nav,
          .emoji-picker-no-nav .emoji-mart-bar,
          .emoji-picker-no-nav .emoji-mart-anchors,
          .emoji-picker-no-nav .emoji-mart-anchor,
          .emoji-picker-no-nav .emoji-mart-category-list,
          .emoji-picker-no-nav [data-id="nav"],
          .emoji-mart-nav,
          .emoji-mart-bar,
          .emoji-mart-anchors,
          .emoji-mart-anchor,
      ...
      <Picker
        ...
        className="w-full emoji-picker-no-nav"
        noNavBar={true}
        noCountryFlags={true}
      />
    </div>
